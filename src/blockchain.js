...
class Blockchain {
    ...
    _addBlock(block) {
        return new Promise(async (resolve, reject) => {
            ...
            reject("Add block failure - Chain not validated.");
        });
    }
    /**
    ...
    requestMessageOwnershipVerification(address) {
        return new Promise((resolve, reject) => {
            ...
            reject("Message ownership verification failed.")
        });
    }
    /**
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (parseInt(new Date().getTime().toString().slice(0, -3)) - parseInt(message.split(':')[1]) <= 300) {
                ...
                if (valid) {
                    ...
                    let block = await self._addBlock(starBlock);
                    resolve(block)
                }
    ...
    getBlockByHash(hash) {
        ...
        return new Promise((resolve, reject) => {
           ...
           reject("Block by Hash retrieval failed.");
        });
    }
    /**
    ...
    getBlockByHeight(height) {
        ...
        return new Promise((resolve, reject) => {
            ...
            reject("Get block by height error.")
        });
    }
    /**
    ...
    getStarsByWalletAddress (address) {
        ...
        return new Promise(async (resolve, reject) => {
            for (const value of self.chain) {
                let parseValue = await value.getBData();
                if (parseValue.owner === address) stars.push(parseValue);
            }
            resolve(stars);
            reject("Get stars by wallet failed.");
        });
    }
    /**
